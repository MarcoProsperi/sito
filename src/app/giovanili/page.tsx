                    ...
                    <div className="lg:col-span-2 space-y-8 flex flex-col h-full">
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {[1, 2].map((i) => (
                                    <Link key={i} href="/news" className="group">
                                        <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
                                            <div className="relative h-48 bg-gradient-to-br from-virtus-blue to-virtus-yellow">
                                                <div className="absolute inset-0 flex items-center justify-center text-white font-bold">
                                                    NEWS PLACEHOLDER
                                                </div>
                                            </div>
                                            <div className="p-4">
                                                <span className="text-xs font-bold text-virtus-yellow uppercase">Ultima Ora</span>
                                                <h3 className="font-display font-bold text-lg text-virtus-blue mt-1 group-hover:text-virtus-yellow transition-colors">
                                                    Titolo Notizia {i}
                                                </h3>
                                                <p className="text-sm text-gray-600 mt-2 line-clamp-2">
                                                    Breve anteprima della notizia per attirare l'attenzione dei lettori...
                                                </p>
                                            </div>
                                        </div>
                                    </Link>
                        ...
                        <section className="bg-white rounded-lg p-6 shadow-md">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="mt-6 pt-4 border-t border-gray-200">
                                    <h4 className="text-sm font-bold text-virtus-blue mb-3 uppercase">Ultimi Post</h4>
                                    <InstagramGrid />
                                </div>
                            </div>
                        </section>

            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {teams.map((team, index) => (
                    <Link
                        key={index}
                        href="#"
                        className="group bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col items-center justify-center hover:shadow-md hover:border-virtus-blue transition-all cursor-pointer"
                    >
